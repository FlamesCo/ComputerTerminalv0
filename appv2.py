...
class TextEditor(tk.Tk):
    ...
    def initUI(self):
        ...
        self.title("<FLAMES CO  COMPUTER TERMINAL 1.0 FT> [C] PROUDLY BY FLAMES LLC")
        ## disable maximize button circle dot to not working
        ...
        self.language_dropdown = tk.OptionMenu(self, self.language_var, "English,Bing API Search, Youtube Crawler 1.0,Python", "HTML", "C#", "Rust, .cpp,.c, .asm,","SM64 AI Game Sync",".z64", "[PLEASE SELECT ROM]")
    ...
    def generate_code(self):
        ...
        response = openai.Completion.create(
            engine="code-davinci-002",  # Use the Ada engine
